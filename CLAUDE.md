...
- Interactive features (anything the user clicks, drags, types into, or otherwise operates) — post a short video showing the interaction actually working end to end. When capturing that video, make sure the relevant element is scrolled into view and stays in frame for the whole interaction, not just present somewhere in the page.
